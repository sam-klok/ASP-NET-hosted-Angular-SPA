...
- Create Angular project with ng: `ng new asp-net-hosted-angular-spa.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`asp-net-hosted-angular-spa.client.esproj`).
